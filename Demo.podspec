...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "chaoyueshan"
  # s.authors            = { "chaoyueshan" => "chaoyueshan@u51.com" }
  # s.social_media_url   = "http://twitter.com/chaoyueshan"
  ...
  s.source       = { :git => "https://gtihub.com/chaoyueshan1012/Demo.git", :tag => "0.0.1" }
