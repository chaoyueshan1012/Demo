...
//  Demo
//
//  Created by chaoyueshan on 16/7/6.
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "creat51.com.Demo" in the application's documents directory.
